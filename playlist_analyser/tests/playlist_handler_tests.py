...
# class PlaylistHandlerTest(pytest):
@pytest.fixture
def handler():
...
def test_get_playlist_from_url(handler):
    ...
    assert html.unescape(playlist['description']) == "I should've burned this place down when I had the chance"
    assert playlist['owner']['display_name'] == "Ishan"
    assert playlist['images'][0]['url'] == "https://mosaic.scdn.co/640/ab67616d0000b27337b16a48dec737a46b244ea2ab67616d0000b273586acdba3a0ddc93693a313eab67616d0000b273a6b996b1140c516deda4b9b0ab67616d0000b273cab7ae4868e9f9ce6bdfdf43"
...
def test_get_playlist_id_from_link(handler):
    playlist_id = handler.get_playlist_id_from_link("https://open.spotify.com/playlist/37i9dQZF1DXcBWIGoYBM5M")
    assert playlist_id == "37i9dQZF1DXcBWIGoYBM5M"
    with_q_mark = handler.get_playlist_id_from_link("https://open.spotify.com/playlist/37i9dQZF1DXcBWIGoYBM5M?si=3e2e2e2e2e2e2e2e")
...
def test_get_playlist(handler):
    ...
    assert playlist.url == "https://open.spotify.com/playlist/6cUbe8r2kP140bL0Z2HHXV"
    assert playlist.name == "Fleece it out"
    assert playlist.description == "I should've burned this place down when I had the chance"
    assert playlist.author == "Ishan"
    assert playlist.thumbnail == "https://mosaic.scdn.co/640/ab67616d0000b27337b16a48dec737a46b244ea2ab67616d0000b273586acdba3a0ddc93693a313eab67616d0000b273a6b996b1140c516deda4b9b0ab67616d0000b273cab7ae4868e9f9ce6bdfdf43"
